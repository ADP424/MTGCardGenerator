...
class RegularOmen(RegularCard):
    ...
    def __init__(
        ...
        self.ADVENTURE_TITLE_MAX_FONT_SIZE = 80
        ...
        self.ADVENTURE_TYPE_BOTTOM_Y = 1997
        ...
        self.ADVENTURE_RULES_BOX_HEIGHT = 529

        # Rules Text
        self.RULES_TEXT_MAX_FONT_SIZE = 94

        # Right Rules Text
        self.RULES_TEXT_X = 1033
        ...
        self.ADVENTURE_RULES_TEXT_HEIGHT = 529
