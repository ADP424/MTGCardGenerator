...
class ShortModalFrontside(ModalFrontside):
    """
    A layered image representing the frontside of a short modal DFC card and all the collection info on it,
