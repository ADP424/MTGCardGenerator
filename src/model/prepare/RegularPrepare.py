...
class RegularPrepare(RegularCard):
    """
    ...
    def __init__(
        ...
        self.ADVENTURE_TITLE_BOX_X = 1020
        self.ADVENTURE_TITLE_BOX_Y = 1774
        self.ADVENTURE_TITLE_BOX_WIDTH = 858
        self.ADVENTURE_TITLE_BOX_HEIGHT = 118
        ...
        self.ADVENTURE_TITLE_X = 1041
        self.ADVENTURE_TITLE_BOTTOM_Y = 1869
        self.ADVENTURE_TITLE_WIDTH = 844
        self.ADVENTURE_TITLE_MAX_FONT_SIZE = 83
        ...
        self.ADVENTURE_TYPE_X = 1041
        self.ADVENTURE_TYPE_BOTTOM_Y = 1991
        self.ADVENTURE_TYPE_WIDTH = 844
        self.ADVENTURE_TYPE_MAX_FONT_SIZE = 83
        self.ADVENTURE_TYPE_FONT_COLOR = (255, 255, 255)

        # Right Rules Text Box
        self.RULES_BOX_X = 150
        self.RULES_BOX_Y = 1773
        self.RULES_BOX_WIDTH = 844
        self.RULES_BOX_HEIGHT = 835

        # Prepare Spell Rules Text Box
        self.ADVENTURE_RULES_BOX_X = 1018
        self.ADVENTURE_RULES_BOX_Y = 2048
        self.ADVENTURE_RULES_BOX_WIDTH = 844
        self.ADVENTURE_RULES_BOX_HEIGHT = 453

        # Rules Text
        self.RULES_TEXT_MAX_FONT_SIZE = 99

        # Right Rules Text
        self.RULES_TEXT_X = 150
        self.RULES_TEXT_Y = 1762
        self.RULES_TEXT_WIDTH = 847
        self.RULES_TEXT_HEIGHT = 835

        # Prepare Spell Rules Text
        self.ADVENTURE_RULES_TEXT_X = 1010
        self.ADVENTURE_RULES_TEXT_Y = 2048
        self.ADVENTURE_RULES_TEXT_WIDTH = 852
        self.ADVENTURE_RULES_TEXT_HEIGHT = 453
