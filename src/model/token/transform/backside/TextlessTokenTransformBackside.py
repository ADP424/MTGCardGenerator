...
class TextlessTokenTransformBackside(TransformBackside):
    """
    A layered image representing a textless token transform backside and all the collection info on it,
