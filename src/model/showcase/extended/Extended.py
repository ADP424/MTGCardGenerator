...
class Extended(RegularCard):
    """
    A layered image representing a card with an extended showcase frame and all the collection info on it,
    with all relevant card metadata. Identical to a regular card except the type line text is white.
