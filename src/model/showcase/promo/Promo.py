...
class Promo(RegularCard):
    ...
    def __init__(
        ...
        # Type Box
        self.TYPE_BOX_Y = 1825

        # Type Text
        self.TYPE_BOTTOM_Y = 1950
        self.TYPE_FONT_COLOR = (255, 255, 255)
        self.TYPE_TEXT_DROP_SHADOW_RELATIVE_OFFSET = (0.03, 0.03)

        # Rules Text Box
        self.RULES_BOX_Y = 1997
        self.RULES_BOX_HEIGHT = 600

        # Rules Text
        self.RULES_TEXT_Y = 1997
        self.RULES_TEXT_HEIGHT = 600
