...
class StainedGlass(RegularCard):
    """
    A layered image representing a stained glass showcase card, identical to a regular card
    except all text is white, with all the collection info on it, with all relevant card metadata.
    ...
    def __init__(
        self,
        metadata: dict[str, str | list["StainedGlass"]] = None,
